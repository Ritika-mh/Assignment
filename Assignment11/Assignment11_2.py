...
def Directory_Checksumcal(Dir):
    print("Inside Duplicate file searching")
...
def main():
    print("Duplicate file finding application")
    if (argv[1] == "-h"):
        print("This script will travel the directory and write name of duplicate file in directory")
        exit()
